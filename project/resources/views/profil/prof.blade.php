...
<div class=" dark:bg-gray-900 gap-6 flex items-center justify-center mb-9">
  <div
    ...
    />
      <div class="w-fit transition-all transform duration-500">
        <h1 class="text-gray-600 dark:text-gray-200 font-bold">
          <span class="font-bold text-blue-200">Prof : </span> {{$user->Firstname}}
        </h1>
        <p class="text-gray-400">Prof</p>
        <a
    ...
    <div class="absolute group-hover:bottom-1 delay-300 -bottom-16 transition-all duration-500 bg-gray-600 dark:bg-gray-100 right-1 rounded-lg">
      <div class="flex justify-evenly items-center gap-2 p-1 text-2xl text-white dark:text-gray-600">
        <svg viewBox="0 0 1024 1024" fill="currentColor" height="1em" width="1em" class="hover:fill-sky-500">
          <path
        ...
        <svg fill="currentColor" viewBox="0 0 16 16" height="1em" width="1em" class="hover:fill-blue-600">
          <path
            d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
        </svg>
        <svg viewBox="0 0 960 1000" fill="currentColor" height="1em" width="1em" class="hover:fill-blue-800">
          <path
    ...
    <div class="xl:w-[80%] sm:w-[85%] xs:w-[90%] mx-auto flex md:flex-row xs:flex-col lg:gap-4 xs:gap-2 justify-center lg:items-stretch md:items-center mt-4">
      <div class="lg:w-[50%] xs:w-full">
        <img class="lg:rounded-t-lg sm:rounded-sm xs:rounded-sm" src="https://images.unsplash.com/photo-1501504905252-473c47e087f8" alt="billboard image" />
      </div>
      <div class="lg:w-[50%] sm:w-full xs:w-full bg-gray-100 dark:bg-gray-900 dark:text-gray-400 md:p-4 xs:p-0 rounded-md">
        <a href="{{route('Pcourses',$user->id)}}" class="text-3xl font-semibold text-gray-900 dark:text-white capitalize">courses</a >
    ...
    <div class="xl:w-[80%] sm:w-[85%] xs:w-[90%] mx-auto flex md:flex-row xs:flex-col lg:gap-4 xs:gap-2 justify-center lg:items-stretch md:items-center mt-6">
      ...
      <div class="lg:w-[50%] xs:w-full bg-gray-100 dark:bg-gray-900 dark:text-gray-400 md:p-4 xs:p-0 rounded-md">
        <a href="#" class="text-3xl font-semibold text-gray-900 dark:text-white capitalize">heures suppplemantaires</a>
      ...
      <div class="md:block sm:hidden xs:hidden lg:w-[50%] xs:w-full">
        <img class="lg:rounded-t-lg xs:rounded-sm" src="https://images.unsplash.com/photo-1581726707445-75cbe4efc586" alt="billboard image" />
      </div>
    </div>
  </section>
